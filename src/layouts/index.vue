<template>
  <div class="vue-wrapper" :class="classObj">
    <div
    ...
    >
      <div v-if="device === 'mobile' && collapse === false" class="mask" @click="handleFoldSideBar"></div>
      <vab-side-bar />
...
.vue-wrapper {
  ...
  .layout-container-vertical {
    ...
    .vab-main {
      position: relative;
      min-height: calc(100% - #{$base-top-bar-height} - #{$base-tabs-bar-height} - #{$base-padding});
