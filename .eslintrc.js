module.exports = {
  ...
  rules: {
    ...
    "arrow-spacing": [2, { before: true, after: true }], // 箭头函数中的箭头前后加空格
    "block-spacing": [2, "always"], // 花括号内前后加空格
    "brace-style": [2, "1tbs", { allowSingleLine: true }], // 允许单行方法
    ...
    "generator-star-spacing": [2, { before: true, after: true }], // 生成器函数前后加空格
    // "handle-callback-err": [2, "^(err|error)$"], //err的错误回调必须处理
    indent: [2, 2, { SwitchCase: 1 }], // 2位缩进
    "key-spacing": [2, { beforeColon: false, afterColon: true }], // 对象字面亮键和冒号之间存在空格
    ...
    "semi-spacing": [2, { before: false, after: true }], // 强制在块之前使用一致的空格
